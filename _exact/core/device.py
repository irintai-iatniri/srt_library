...
Examples:
    >>> from syntonic_applications.core.device import cpu, cuda, device
...
from applications._core import cuda_device_count as _rust_cuda_count

# Import CUDA functions from Rust backend
from applications._core import cuda_is_available as _rust_cuda_available
