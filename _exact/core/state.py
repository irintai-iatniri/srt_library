...
from applications._core import TensorStorage, cuda_is_available
from applications.core.device import Device, cpu, cuda
from applications.core.dtype import DType, complex128, float64, get_dtype, get_default_dtype, golden_exact, fixed_point64
...
class State:
    ...
    def to_rational(self) -> "State":
        ...
        """
        from applications.core.dtype import rational
    ...
    def cuda_async(self, device_id: int = 0, wait: bool = True) -> "State":
        ...
        if wait:
            from applications.core import TensorStorage
    ...
    def __mul__(self, other) -> "State":
        from applications.exact import GoldenExact, Rational
    ...
    def normalize(self) -> "State":
        ...
        from applications.exceptions import SyntonicError
