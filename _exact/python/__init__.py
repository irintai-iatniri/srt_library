...
Example:
    >>> from syntonic_applications.srt import create_srt_system
...
from applications.srt.constants import (
    D4_KISSING,
    E6_GOLDEN_CONE,
    E8_POSITIVE_ROOTS,
    E8_ROOTS,
...
# Corrections
from applications.srt.corrections import (
    CorrectionFactors,
    correction_factors,
)

# Prime selection
from applications.srt.fermat_forces import (
    fermat_number,
    get_force_spectrum,
    is_fermat_prime,
...
# Functional
from applications.srt.functional import (
    SyntonyFunctional,
    compute_syntony,
    syntony_functional,
)
...
# Golden operations
from applications.srt.golden import (
    GoldenMeasure,
    GoldenRecursionMap,
    golden_measure,
...
# Lattice
from applications.srt.lattice import (
    K_D4,
    D4Lattice,
    D4Root,
    E8Lattice,
...
from applications.srt.lucas_shadow import (
...
from applications.srt.mersenne_matter import (
...
# from syntonic_applications.srt.prime_selection import (
...
#     dark_matter_mass_prediction,
# )
from applications.srt.transcendence import (
