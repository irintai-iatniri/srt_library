...
// Derived from canonical constants — φⁿ = F(n)φ + F(n-1)
#define PHI         PHI_F64
#define PHI_INV     PHI_INV_F64
#define PHI_SQUARED PHI_SQ_F64
#define PHI_CUBED   (2.0 * PHI_F64 + 1.0)      // 2φ + 1
#define PHI_FOURTH  (3.0 * PHI_F64 + 2.0)      // 3φ + 2
#define PHI_FIFTH   (5.0 * PHI_F64 + 3.0)      // 5φ + 3
#define PI          PI_F64
#define E           EULER_E_F64
#define E_STAR      E_STAR_F64
#define Q           Q_DEFICIT_F64
