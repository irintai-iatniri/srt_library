...
from srt_library.core.exact import GoldenExact, Rational, PHI_INVERSE
...
# Use exact golden inverse from srt_library.core.exact
PHI_INV = PHI_INVERSE
...
class DifferentiationOperator(OperatorBase):
    ...
    def __init__(
        ...
        def to_golden(x):
            ...
            # For float/int, approximate as GoldenExact
    ...
    def apply(
        ...
        **kwargs,
        ...
        if isinstance(S_val, GoldenExact):
            ...
            S_ge = GoldenExact.nearest(float(S_val), 1 << 30)
        ...
        for i, projector in enumerate(projectors):
            ...
            if not isinstance(w_ge, GoldenExact):
                w_ge = GoldenExact.nearest(float(w_ge), 1 << 30)
