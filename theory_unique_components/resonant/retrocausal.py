...
```python
from ..resonant import ResonantTensor
from ..resonant.retrocausal import create_retrocausal_evolver, RetrocausalConfig
...
from srt_library.core._core import RESConfig, ResonantEvolver, ResonantTensor
...
def create_retrocausal_evolver(
    ...
    **kwargs,
    ...
    Example:
        >>> from srt_library.core.resonant import ResonantTensor
        >>> from srt_library.core.resonant.retrocausal import create_retrocausal_evolver
        >>>
        >>> tensor = ResonantTensor([1.0, 2.0, 3.0, 4.0], [4])
...
def create_standard_evolver(
    ...
    Example:
        >>> from srt_library.core.resonant import ResonantTensor
        >>> from srt_library.core.resonant.retrocausal import create_standard_evolver
        >>>
        >>> tensor = ResonantTensor([1.0, 2.0, 3.0, 4.0], [4])
...
def compare_convergence(
    ...
    Example:
        >>> from srt_library.core.resonant import ResonantTensor
        >>> from srt_library.core.resonant.retrocausal import compare_convergence
        >>>
        >>> tensor = ResonantTensor([1.0, 2.0, 3.0, 4.0], [4])
