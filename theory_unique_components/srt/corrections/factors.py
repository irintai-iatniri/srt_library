...
Example:
    >>> from srt_library.theory_unique_components.srt.corrections import correction_factors
...
from srt_library.core.exact import Q_DEFICIT_NUMERIC, STRUCTURE_DIMENSIONS
