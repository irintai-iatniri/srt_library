...
Uses exact rational arithmetic from srt_library.core.exact.Rational.

Example:
    >>> from srt_library.theory_unique_components.srt.lattice import e8_lattice
    >>> E8 = e8_lattice()
    >>> len(E8.roots)
    240
...
from srt_library.core.exact import Rational
...
class E8Root:
    ...
    which is compatible with srt_library.core.exact.Rational for conversions.
    ...
    def to_rational_tuple(self) -> Tuple[Rational, ...]:
        """
        Convert coordinates to srt_library.core.exact.Rational tuple.

        Returns:
            Tuple of Rational values from srt_library.core.exact
        """
        return tuple(
    ...
    def norm_squared_rational(self) -> Rational:
        """
        Compute squared norm as srt_library.core.exact.Rational.
