...
Example:
    >>> from srt_library.theory_unique_components.srt.lattice import golden_cone, e8_lattice
    >>> cone = golden_cone()
    >>> len(cone.roots)
    36
"""
...
from srt_library.core.exact import PHI_NUMERIC
from srt_library.theory_unique_components.srt.lattice.quadratic_form import QuadraticForm

if TYPE_CHECKING:
    from srt_library.theory_unique_components.srt.lattice.e8 import E8Lattice, E8Root
